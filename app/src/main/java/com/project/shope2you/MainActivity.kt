   ...
   //private lateinit var Binding:ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navController2.addOnDestinationChangedListener { controller, destination, arguments ->
            ...
            else if (destination.id == R.id.product) {
                bottom.visibility=View.GONE
            }
        ...
        bottom.setOnItemSelectedListener { item ->
            when (item.itemId) {
                R.id.home2 -> findNavController().navigate(R.id.home2)
                R.id.cart2 -> findNavController().navigate(R.id.cart2)
                R.id.profile2 -> findNavController().navigate(R.id.profile2)
            }
            true
        }
